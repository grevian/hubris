...
impl FlashDriverInterface {
    ...
    unsafe fn flash_init(&self, config: &mut FlashConfig) -> u32 {
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.flash_init)(config),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.flash_init)(config)
        }
    }

    unsafe fn ffr_init(&self, config: &mut FlashConfig) -> u32 {
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.ffr_init)(config),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.ffr_init)(config)
        }
    }
    ...
    unsafe fn flash_verify_erase(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.flash_verify_erase)(config, start, length),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.flash_verify_erase)(config, start, length)
        }
    }
    ...
    unsafe fn flash_program(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.flash_program)(config, start, src, length),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.flash_program)(config, start, src, length)
        }
    }
    ...
    unsafe fn ffr_keystore_get_kc(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.ffr_keystore_get_kc)(config, p_key_code, key_index),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.ffr_keystore_get_kc)(config, p_key_code, key_index)
        }
    ...
    unsafe fn ffr_keystore_get_ac(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.ffr_keystore_get_ac)(config, ac),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.ffr_keystore_get_ac)(config, ac)
        }
    ...
    unsafe fn ffr_keystore_write(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.ffr_keystore_write)(config, p_key_store),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.ffr_keystore_write)(config, p_key_store)
        }
    }
    ...
    unsafe fn ffr_get_customer_data(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.ffr_get_customer_data)(config, pdata, offset, len),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.ffr_get_customer_data)(config, pdata, offset, len)
        }
    ...
    unsafe fn flash_erase(
        ...
        match self.rom_api_version() {
            RomApiVersion::RomApiV1 => (self.version1_flash_driver.flash_erase)(config, start, length, key),
            RomApiVersion::RomApiV0 => (self.version0_flash_driver.flash_erase)(config, start, length, key)
        }
    }
...
pub fn validate_programmed(start: u32, len: u32) -> bool {
    ...
    let v = handle_flash_status(unsafe {
        bootloader_tree().flash_driver.flash_verify_erase(&mut f, start, len)
    });
...
pub fn get_key_code(
    ...
    handle_flash_status(unsafe { bootloader_tree()
            .flash_driver.flash_init(&mut f)})?;
